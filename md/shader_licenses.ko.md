...
이 문서는 GPosingway와 함께 재배포되는 셰이더 컬렉션 및 개별 셰이더와 각각의 라이선스 및 저작자를 나열합니다. 자세한 내용은 링크된 리포지토리를 방문하십시오.

---

## 셰이더 컬렉션 (Shader Collections)
...
## 라이선스 또는 저작자가 알려지지 않은 셰이더 (Shaders with Unknown License or Author)
...
자세한 내용은 [ReShade Shader Repository](https://reshade.me)를 방문하십시오.
